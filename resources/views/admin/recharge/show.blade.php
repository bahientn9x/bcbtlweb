					...
					<div class="row">
                            <div class="col-sm-12">
                                <form class="form-horizontal">
                                     <div class="form-group"><a title="Thông tin chi tiết khách" href="admin/members/{{$data->member->id}}"><label class="col-sm-3 control-label">Tên khách</label></a>
					...
					<div class="row">
                            <div class="col-sm-12">
                                ...
                                {{-- <div class="form-group"><label class="col-sm-3 control-label">Người nhận</label>
                                    <div class="col-sm-9"><input type="text" readonly value="" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div> --}}
