        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <a href="{{url('profile')}}"><button type="button" class="btn btn-primary">Cập nhật thông tin</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="modal-prd" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <a href="{{url('home')}}"><button type="button" class="btn btn-primary">Quay lại trang chủ</button></a>
                    ...
                    <div class="profile-detail-content cp-t">
                        <form action="{{ url('order') }}" method="post" id="form-order" enctype="multipart/form-data">
                                ...
                                <table class="table table-responsive-sm table-order" >
                                    ...
                                    <tr>
                                        <td >
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <img src="{{ asset($info_product['icon']) }}" alt="" class="img-thumbnail img-product-pay">
                                                </div>
                                                <div  class="col-6">
                            ...
                            <?php if (Auth::user()->id != $info_product['member_id']): ?>
                                ...
                                <div class="mt-3">
                                    <div class="form-group btn-submit " >
                                        <button class="btn" id="btn-order">Bán mặt hàng</button>
                                    </div>
                                </div>
                            <?php endif ?>
                        </form>
